module Fastlane
  module Helper
    class SmmcS3Helper
      ...
      # as `Helper::SmmcS3Helper.your_method`
      #
      def self.show_message
        UI.message("Hello from the smmc_s3 plugin helper!")
      end
      ...
      def self.load(template_name)
        path = "#{Helper.gem_path('fastlane-plugin-smmc_s3')}/lib/assets/#{template_name}.erb"
        puts "path #{path}"
        load_from_path(path)
      end
